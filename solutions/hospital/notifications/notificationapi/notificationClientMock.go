...
// Source: notifications_grpc.pb.go
...
// mustEmbedUnimplementedNotificationServer mocks base method.
func (m *MockNotificationServer) mustEmbedUnimplementedNotificationServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedNotificationServer")
}

// mustEmbedUnimplementedNotificationServer indicates an expected call of mustEmbedUnimplementedNotificationServer.
func (mr *MockNotificationServerMockRecorder) mustEmbedUnimplementedNotificationServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedNotificationServer", reflect.TypeOf((*MockNotificationServer)(nil).mustEmbedUnimplementedNotificationServer))
}

// MockUnsafeNotificationServer is a mock of UnsafeNotificationServer interface.
type MockUnsafeNotificationServer struct {
	ctrl     *gomock.Controller
	recorder *MockUnsafeNotificationServerMockRecorder
}

// MockUnsafeNotificationServerMockRecorder is the mock recorder for MockUnsafeNotificationServer.
type MockUnsafeNotificationServerMockRecorder struct {
	mock *MockUnsafeNotificationServer
}

// NewMockUnsafeNotificationServer creates a new mock instance.
func NewMockUnsafeNotificationServer(ctrl *gomock.Controller) *MockUnsafeNotificationServer {
	mock := &MockUnsafeNotificationServer{ctrl: ctrl}
	mock.recorder = &MockUnsafeNotificationServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUnsafeNotificationServer) EXPECT() *MockUnsafeNotificationServerMockRecorder {
	return m.recorder
}

// mustEmbedUnimplementedNotificationServer mocks base method.
func (m *MockUnsafeNotificationServer) mustEmbedUnimplementedNotificationServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedNotificationServer")
}

// mustEmbedUnimplementedNotificationServer indicates an expected call of mustEmbedUnimplementedNotificationServer.
func (mr *MockUnsafeNotificationServerMockRecorder) mustEmbedUnimplementedNotificationServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedNotificationServer", reflect.TypeOf((*MockUnsafeNotificationServer)(nil).mustEmbedUnimplementedNotificationServer))
}
